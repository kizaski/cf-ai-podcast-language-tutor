...
export const Transcript = ({
  ...
  return (
    <div>
      ...
      <div
        className={`space-y-3 transition-all duration-500 ease-in-out ${expanded === "both" ? "max-h-[28vh]" : "max-h-0"} ${expanded === "transcript" ? "max-h-[50vh]" : ""} overflow-y-auto rounded-lg`}
      >
